...
def _save_feedback(content: str) -> None:
    """把一條反饋追加到 ~/.recallos/feedback.log。"""
    content = (content or "").strip()
    if not content:
        st.warning("請先輸入一些內容再提交。")
        return
